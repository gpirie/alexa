...
const handlers = {
    ...
    'GetAlphabet': function () {
        ...
        const speechOutput = this.t('GET_FACT_MESSAGE') + alphabetArr;
        this.emit(':tellWithCard', speechOutput, this.t('SKILL_NAME'), alphabetArr);
    },
...
var newSessionHandlers = {
    'LaunchRequest': function () {
        ...
        this.emit(':ask', skillName + " " + HELP_REPROMPT, HELP_REPROMPT);
    },
	'Unhandled': function () {
